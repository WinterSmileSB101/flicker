 ...
 */
@JsonSerialize(as = KillActorTelemetryEvent.class)
@JsonDeserialize(as = KillActorTelemetryEvent.class)
public class KillActorTelemetryEvent extends TelemetryEvent {
